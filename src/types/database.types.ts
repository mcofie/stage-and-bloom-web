    ...
    public: {
        Tables: {
            ...
            vendor_photos: {
                ...
                Update: Partial<Database['public']['Tables']['vendor_photos']['Row']>
                Relationships: []
            }
            vendor_rates: {
                Row: {
                ...
                Insert: Partial<Database['public']['Tables']['vendor_rates']['Row']>
                Update: Partial<Database['public']['Tables']['vendor_rates']['Row']>
                Relationships: []
            }
            booking_requests: {
                Row: {
        ...
        Views: {
            // if you created a vendor_search_index view, you can type it here
            vendor_search_index: {
                Row: {
                    id: string
                    slug: string
        ...
        Enums: {
            // if you used sb_booking_status / sb_pricing_model enums, you can add them here

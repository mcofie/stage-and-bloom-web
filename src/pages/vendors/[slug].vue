<template>
  <div class="font-sans bg-white text-slate-900 min-h-screen relative">
    ...
    <footer class="bg-slate-900 text-white border-t border-slate-800 pt-16 pb-8 mt-auto relative overflow-hidden">
      ...
      <div
          class="absolute bottom-0 right-1/4 w-96 h-96 bg-purple-600/10 rounded-full blur-3xl pointer-events-none"></div>

    ...
    <div class="max-w-md w-full bg-white rounded-3xl border border-slate-100 shadow-lg shadow-rose-50 p-8 space-y-6">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-[10px] uppercase tracking-[0.2em] text-slate-500 mt-1">Create account</p>
        </div>
      </div>

      <div class="space-y-2">
        <h1 class="font-serif text-2xl font-semibold text-slate-900">Join the list</h1>
        <p class="text-xs text-slate-500">
          Save your favourite vendors and send requests faster.
        </p>
      </div>
      ...
      <p class="text-xs text-slate-500 text-center">
        ...
        <NuxtLink
            :to="{ path: '/auth/sign-in', query: { redirect: redirectTo } }"
